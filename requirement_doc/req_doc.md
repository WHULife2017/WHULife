...
| 字段名     | 数据类型  | 长度 | 主键 | 非空 | 描述                                 |
| ---------- | --------- | ---- | ---- | ---- | ------------------------------------ |
| 计划 id    | INTEGER   | 32   | 是   | 是   | 提醒计划的唯一标识号                 |
| 时间       | TIMESTAMP | 4    | 否   | 否   | 待办事项的时间                       |
| 经度       | FLOAT     | 32   | 否   | 否   | 待办事项的地点经度                   |
| 纬度       | FLOAT     | 32   | 否   | 否   | 待办事项的地点纬度                   |
| 通知信息   | VARCHAR   | 60   | 否   | 是   | 提醒时的弹窗信息                     |
| 备注信息   | VARCHAR   | 200  | 否   | 是   | 详细的事项描述                       |
| 状态       | VARCHAR   | 10   | 否   | 是   | 事项的状态, [未添加\|待提醒\|已处理] |
| 已提醒次数 | SMALLINT  | 16   | 否   | 是   | 已经提醒的次数                       |
